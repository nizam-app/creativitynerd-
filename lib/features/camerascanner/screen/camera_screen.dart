...
//   }
//
//   // ✅ OCR mode এ background tap করলে OrcExtrect এ যাবে
//   void _onBackgroundTap() {
//     if (_selectedMode == _modeOcr) {
//       // routeName থাকলে এটা use করো
//       context.push(OrcExtrect.routeName);
//
//       // routeName না থাকলে, তোমার custom route:
...
//                   children: [
//                     // ✅ background clickable only for OCR
//                     ClipRRect(
//                       child: AspectRatio(
//                         aspectRatio: 3 / 4.4,
//                         child: Opacity(
//                           opacity:
//                           _selectedMode == _modeIdCard ? 0.5 : 1.0,
//                           child: Image.asset(
//                             _backgroundImage,
//                             fit: BoxFit.cover,
//                           ),
